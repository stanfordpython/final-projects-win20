...
"""
APP_TITLE = 'Florida Man Birthday'            # Appears at the top of the page.
AUTHORS = 'Corbin Schmeil and Dylan Ly'              # Appears underneath the title
FORM_DESCRIPTION = "Enter your Birthday to see what Florida Man was doing..." # Appears before the form, to explain the form
...
'date':('Date (enter a real date please!)',FormInputs.NUMERIC)}
